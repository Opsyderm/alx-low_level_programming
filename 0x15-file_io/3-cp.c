 ...
 *
 * Return: this a  pointer to the newly-allocated buffer.
 */
char *create_buffer(char *file)
{
	char *buffer;
...
/**
 * close_file - this will close file descriptors.
 ...
 *
 * Description: if argument count isn't correct - exit code 97.
