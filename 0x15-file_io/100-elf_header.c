 ...
 * @e_ident: this will point to an array containing the ELF magic numbers.
 *
...
/**
 * close_elf -this will  Close an ELF file.
...
/**
 * main - this will displays the information contained in the
